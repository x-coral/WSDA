...
def main(exp_dir, last_model_path, pseudoseg_save_path, pseudodet_save_path, ratio0, ratio):
    ...
    targetloader = data.DataLoader(
        targetDataSet_train_step2_uda(args.data_dir_target, maxpointlab_save_path, partial_pseudolabel_save_path, pseudodet_save_path,
...
if __name__ == '__main__':
    ...
    exp_base_name = 'R2H_0%_stage2_0-1'
    last_exp_dir = './WSDA_R2H/R2H_0%_stage1/iter4'
    ...
    code_path_list= ['./02_Stage2_WSDA-UDA_final.py', './add_arguments.py', './model/HSC82.py',
    ...
    for iter in range(1, 3):
        ...
        point_num = val_threshold(last_model_path, pseudoseg_save_path, pseudodet_save_path, args, threshold=0.8)
       
        print('============Generate Pseudo Label Start============')

        label_selected_ratio0 = 0.15
        label_selected_ratio = min(iter * 0.5, 0.95)
